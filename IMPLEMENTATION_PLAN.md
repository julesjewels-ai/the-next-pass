...
6.  **Financial Guidance (Phase 4)**
    -   [ ] **Compensation Estimates**: Add base salary and signing bonus to jobs, and implement a service to display estimated compensation for matching opportunities. (In Progress)
