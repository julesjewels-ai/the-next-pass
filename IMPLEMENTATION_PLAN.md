...
6.  **Financial Guidance (Phase 4) (Completed)**
    -   [x] **Compensation Estimates**: Add base salary and signing bonus to jobs, and display formatted compensation estimates when viewing opportunities.
