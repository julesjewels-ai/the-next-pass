...
def get_compensation_estimate(job: Job) -> str:
    """
    Returns a formatted string representing the estimated compensation for a job.

    Args:
        job: The job to get the compensation estimate for.

    Returns:
        A string formatted as '$[base] base + $[bonus] sign-on', '$[base] base', or 'Compensation not specified'.
    """
