...
SKILL_FIELD_GENERAL = "Field General Leadership"
...
SKILL_DB = {
    ...
    KEY_FOOTBALL_CAPTAIN: (
        "Commanded large-scale team operations, translating coaching strategy "
        "into on-field execution while managing interpersonal dynamics."
    )
}
...
COMPOSITE_SKILL_MAPPINGS = {
    (KEY_FOOTBALL, KEY_CAPTAIN): (SKILL_FIELD_GENERAL, KEY_FOOTBALL_CAPTAIN),
}
