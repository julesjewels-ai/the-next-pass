...
JOBS_DB = [
    ...
    Job(
        ...
        min_grit=HIGH_SCORE_THRESHOLD,
        employer="LogisticsInc",
        required_skills=[SKILL_OPERATIONAL_COMMAND, SKILL_TEAM_COLLABORATION],
        base_salary=80000,
        signing_bonus=7500
    ),
    Job(
        title="Leadership Development Program",
        min_teamwork=HIGH_SCORE_THRESHOLD,
        employer="ConsultingGroup",
        required_skills=[SKILL_LEADERSHIP, SKILL_STRATEGIC_EXECUTION],
        base_salary=90000,
        signing_bonus=15000
    )
]
